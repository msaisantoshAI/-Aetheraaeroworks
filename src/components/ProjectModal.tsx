    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto bg-black/90 backdrop-blur-2xl">
        ...
        <motion.div
          ...
          className="relative z-10 w-full max-w-2xl bg-neutral-950 border border-white/20 rounded-xs shadow-2xl overflow-hidden my-auto max-h-[95vh] flex flex-col"
        >
          {/* Header */}
          <div className="flex items-center justify-between px-5 sm:px-6 py-3.5 sm:py-4 border-b border-white/15 bg-black shrink-0">
            <div className="flex items-center gap-2.5">
              <span className="text-white text-xs sm:text-sm font-bold tracking-widest font-mono">
                ENGINEERING DESK // RFQ & CAD SUBMISSION
              </span>
            </div>
            <button
              onClick={onClose}
            ...
            {submitted ? (
              <div className="py-8 text-center space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs sm:text-sm text-slate-200 max-w-md mx-auto leading-relaxed">
                    Your drawing model and parameters have been logged. The engineering team at Hardware Park, Hyderabad will review and reach out directly at <strong className="text-white">{formData.email}</strong>.
                  </p>
                  <div className="p-3 bg-black rounded-xs border border-white/20 text-xs sm:text-sm text-white font-mono font-bold max-w-xs mx-auto mt-4">
                ...
                <div className="pt-4">
                  <button
                    onClick={handleReset}
                    className="px-8 py-3.5 bg-white text-black text-xs sm:text-sm font-bold tracking-[0.18em] uppercase hover:bg-neutral-200 transition-colors rounded-xs shadow-md"
                  >
                    RETURN TO OVERVIEW
                  </button>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
                  <div>
                    <label className="block text-[11px] sm:text-xs text-slate-300 uppercase tracking-wider mb-1.5 font-bold">
                      Full Name *
                    </label>
                    <input
                      required
                      ...
                      className="w-full bg-black border border-white/30 px-3.5 py-2.5 text-xs sm:text-sm text-white rounded-xs focus:border-white focus:outline-none"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="Aerospace OEM / Defense Agency"
                ...
                <div>
                  ...
                  <label className="flex flex-col items-center justify-center p-4 sm:p-5 border border-dashed border-white/30 rounded-xs bg-black hover:border-white cursor-pointer transition-colors group">
                    <input
                      type="file"
                      ...
                      className="hidden"
                    />
                    <UploadCloud className="w-6 h-6 sm:w-7 sm:h-7 text-slate-300 group-hover:text-white transition-colors mb-1.5" />
                    ...
                    <span className="text-[10px] sm:text-xs text-slate-400 mt-1 text-center">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-black border border-white/30 p-3 text-xs sm:text-sm text-white rounded-xs focus:border-white focus:outline-none"
                  />
                </div>
                ...
                <div className="flex items-center gap-2.5 pt-1">
                  <input
                    ...
                    className="w-4 h-4 rounded-xs border-white/40 text-white focus:ring-0 bg-black"
                  />
                  <label htmlFor="ndaCheck" className="text-xs sm:text-sm text-slate-200 flex items-center gap-2 cursor-pointer font-medium">
                ...
                <div className="pt-4 border-t border-white/15 flex flex-col sm:flex-row items-center justify-between gap-3">
                  <div className="text-[10px] sm:text-xs text-slate-400 font-mono text-center sm:text-left">
                    FACILITY: HARDWARE PARK, HYDERABAD
                  </div>
                  <button
                    type="submit"
                    className="w-full sm:w-auto px-8 py-3.5 bg-white text-black text-xs sm:text-sm font-bold tracking-[0.18em] uppercase rounded-xs hover:bg-neutral-200 active:bg-neutral-300 transition-colors shadow-lg"
                  >
